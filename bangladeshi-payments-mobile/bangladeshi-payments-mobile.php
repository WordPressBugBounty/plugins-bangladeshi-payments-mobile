...
function bangladeshi_payments_mobile_activate() {
        ...
        wp_die(
            esc_html__( 'This plugin requires WooCommerce to be installed and activated. Please install and activate WooCommerce first.', 'bangladeshi-payments-mobile' ),
            esc_html__( 'Plugin Activation Error', 'bangladeshi-payments-mobile' ),
