...
?>
    ...
    public function process_payment($order_id) {
        ...
        if (
    isset( $_POST['rocket_payment_nonce'] )
    && wp_verify_nonce(
        sanitize_text_field( wp_unslash( $_POST['rocket_payment_nonce'] ) ),
        'rocket_payment_action'
    )
) {
    $phone = isset( $_POST['rocket_phone'] )
        ? sanitize_text_field( wp_unslash( $_POST['rocket_phone'] ) )
        : '';

    $trx   = isset( $_POST['rocket_transaction_id'] )
